...
OFILES = main.o game.o myLib.o text.o font.o introScreen.o background.o endScreen.o platform.o walkLeft.o walkRight.o jumpLeft.o jumpRight.o idleLeft.o idleRight.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = game.h myLib.h text.h introScreen.h background.h endScreen.h platform.h walkLeft.h walkRight.h jumpLeft.h jumpRight.h idleLeft.h idleRight.h
